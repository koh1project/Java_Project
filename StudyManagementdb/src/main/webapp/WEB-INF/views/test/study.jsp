...
<body>
   <div class="container">
      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <form action="<spring:url value="/answerSubmit" />" method="POST">
               <input type="hidden" name="correctId" value="${correctId}" />
               <p class="aleart" align="right">
                  ※6秒経過すると<b>不正解</b>となります
               </p>
               ...
               <p align="right">
                  ...
                  残り
                  <span id="timer" style="color: red">6</span>
                  秒
               </p>
               <p>
   ...
   <script>
				...
				var to = function timeOut() {
					window.location.href = '<spring:url value="/answerSubmit" />';
				}
