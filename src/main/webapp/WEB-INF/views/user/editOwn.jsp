            ...
            <form:form modelAttribute="user">
               ...
               <table class="table table-bordered">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <th style="vertical-align: middle;">現在のパスワード</th>
                        <td style="vertical-align: middle;">
                           <c:if test="${currentIsError}">
                              <p>※パスワードが間違っています</p>
                           </c:if>
                     ...
                     <tr>
                        <th style="vertical-align: middle;">新しいパスワード</th>
                        <td style="vertical-align: middle;">
                           <p>
                     ...
                     <tr>
                        <th style="vertical-align: middle;">新しいパスワード確認</th>
                        <td style="vertical-align: middle;">
                           <c:if test="${ checkIsError}">
                         <p>新しいパスワードと一致しません</p>
                           </c:if>
